        ...
        <div id="content-wrapper" class="d-flex flex-column" style="background-image: url(img/Abstract_background_15.jpg);background-size: 100% 100%; background-attachment: fixed; visibility: visible;">
            ...
            <div id="content" >
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Ingreso de Solicitudes</h1>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="container mt-5">
                                    <h2>Ingreso de Solicitud</h2><br>
                                    <form action="insert_solicitud.php" method="POST" class="row g-3">
                                        <div class="col-md-4">
                                            <label for="Id_AreaTrabajo" class="form-label">Jefe Responsable:</label>
                                            <select class="form-select" id="Id_AreaTrabajo" name="Id_AreaTrabajo" required>
                                                ...
                                                $query = "SELECT id, nombre FROM Empleados"; // Cambiado a la tabla Empleados y campo nombre
                                                $result = $conn->query($query);

                                                // Genera las opciones del campo de selección
                                                while ($row = $result->fetch_assoc()) {
                                                    echo '<option value="' . $row['id'] . '">' . $row['nombre'] . '</option>'; // Cambiado a campo nombre
                                                }
                                        ...
                                        <div class="col-md-6">
                                            <label for="equipo_solicitado" class="form-label">Fecha Solicitada:</label>
                                            <input type="date" class="form-control" name="equipo_solicitado" required>
                                        </div>
