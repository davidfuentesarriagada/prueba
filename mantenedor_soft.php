        ...
        <div id="content-wrapper" class="d-flex flex-column" style="background-image: url(img/Abstract_background_15.jpg);background-size: 100% 100%; background-attachment: fixed; visibility: visible;">
            ...
            <div id="content" >
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Mantenedor de Software</h1>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Mantenedor de Software</h6>
                                </div>
                                <div class="container mt-5">
                                    <h2>Agregar Software</h2><br>
                                    <form action="insert_software.php" method="POST" class="row g-3">
                                    <div class="col-md-6">
                                        <label for="nombre" class="form-label">Nombre del Software:</label>
                                        <input type="text" class="form-control" name="nombre" required placeholder="Nombre del Software..">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="version" class="form-label">Versión del Software:</label>
                                        <input type="text" class="form-control" name="version" required placeholder="Ingrese versión..">
                                    </div>

                                    <!-- ... Aquí van otros campos del formulario si es necesario ... -->
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">Agregar Software</button>
                                    </div>
                                </form>
                                <br>
                                </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p>
                                        ...
                                        ingresando algun nuevo Software y sus caracterirsticas.
                                    </p>
