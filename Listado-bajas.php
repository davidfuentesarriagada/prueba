...
<head>
    ...
    <title>Listado de Bajas en Inventario</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column" style="background-image: url(img/Abstract_background_15.jpg);background-size: 100% 100%; background-attachment: fixed; visibility: visible;">
            ...
            <div id="content" >
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Listado de bajas Acumuladas</h1>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Listado de bajas Acumuladas.</h6>
                                </div>
                                <div class="container mt-5">
                                    <h2>Inventario de Bajas</h2>
                                    <?php
                                    ...
                                    // Consulta SQL para obtener los datos desde la tabla "tabla_de_bajas" con limit y offset
                                    $sql = "SELECT codigo_inventario, personal, dispositivo, equipo, software, fecha_baja, motivo FROM tabla_de_bajas LIMIT $registros_por_pagina OFFSET $offset";
                                    $result = $conn->query($sql);

                                    // Contar el total de registros en la tabla de dispositivos para calcular la cantidad de páginas
                                    $sql_total_registros = "SELECT COUNT(*) AS total FROM tabla_de_bajas";
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p>Aqui solo se muestran aparatos que por diversa razon se han dado de baja.
                                    </p>
