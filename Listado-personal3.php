                        ...
                        <div class="col-lg-10 col-sm-12">
                            ...
                            <div class="card shadow mb-5">
                                <div class="container mt-5">
                                    ...
                                    $sql = "SELECT id_formu, rut, nombre, cargo_p, Id_AreaTrabajo, Hijos, Movil, Profesion, Prevision, Enfermedad, Medicamento, Nombre_Emg, Cto_Emg, grupo_sanguineo, direccion, a_medicamento, alergia, flaboral FROM personal LIMIT $offset, $registros_por_pagina";
                                    ...
                                    ?>
                                    <h2 class="text-center">Tabla de Datos Registrados</h2>
                                    <table id="example" class="table-responsive table table-striped table-striped mt-4">
                                        <thead>
                                            <tr>
                                                <th>Nombre</th>
                                                <th>Cargo Comité Paritario</th>
                                                <th>Área de Trabajo</th>
                                                <th>Profesión</th>
