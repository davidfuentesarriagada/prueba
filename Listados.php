        ...
        <div id="content-wrapper" class="d-flex flex-column" style="background-image: url(img/Abstract_background_15.jpg);background-size: 100% 100%; background-attachment: fixed; visibility: visible;">
            ...
            <div id="content" >
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Información de tablas adicionales</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                // Consulta SQL para obtener los datos desde la tabla de equipos y el nombre del Área de Trabajo
                                $sql = "SELECT e.id, a.area, e.marca, e.serie, e.tipo_disco, e.ram, e.s_o, e.created_at FROM equipos e JOIN area_trabajo a ON e.id_area_trabajo = a.id";
                                $result = $conn->query($sql);

                                // Contar el total de registros en la tabla de dispositivos para calcular la cantidad de páginas
                                $sql_total_registros = "SELECT COUNT(*) AS total FROM equipos";
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    $sql = "SELECT nombre, tipo, created_at FROM dispositivos LIMIT $offset, $registros_por_pagina";
                                    $result = $conn->query($sql);

                                    // Contar el total de registros en la tabla de dispositivos para calcular la cantidad de páginas
                                    $sql_total_registros = "SELECT COUNT(*) AS total FROM dispositivos";
                                    $result_total = $conn->query($sql_total_registros);
                                    $row_total = $result_total->fetch_assoc();
                                    $total_registros = $row_total['total'];
                                    $total_paginas = ceil($total_registros / $registros_por_pagina);
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Listado de Software</h6>
                                    </div>
                                    <?php
                                    // Realiza la conexión a la base de datos y realiza la consulta
                                    $servername = "localhost";
                                    ...
                                    // Consulta SQL para obtener los datos desde la tabla de dispositivos con paginación
                                    $sql = "SELECT nombre, version, created_at FROM software LIMIT $offset, $registros_por_pagina";
                                    $result = $conn->query($sql);

                                    // Contar el total de registros en la tabla de dispositivos para calcular la cantidad de páginas
                                    $sql_total_registros = "SELECT COUNT(*) AS total FROM software";
                                    $result_total = $conn->query($sql_total_registros);
                                    $row_total = $result_total->fetch_assoc();
                                    $total_registros = $row_total['total'];
                                    $total_paginas = ceil($total_registros / $registros_por_pagina);
