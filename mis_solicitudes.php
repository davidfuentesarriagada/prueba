        ...
        <div id="content-wrapper" class="d-flex flex-column" style="background-image: url(img/Abstract_background_15.jpg);background-size: 100% 100%; background-attachment: fixed; visibility: visible;">
            ...
            <div id="content" >
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Permisos Administrativos</h1>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="example" class="table table-bordered table-striped">
                                        ...
                                        if (isset($_SESSION['id']) && !empty($_SESSION['id'])) {
                                            ...
                                            $query = "SELECT e.nombre AS jefe_responsable, s.fecha_solicitud, s.justificacion, s.estado, s.fecha_aprobacion FROM Solicitudes s
                                                    INNER JOIN Empleados e ON s.id_jefe = e.id
                                                    WHERE s.id_usuario = $id_usuario"; // Ajusta "id_usuario" según el nombre real de la columna
                                            ...
                                            if ($result) {
                                                if ($result->num_rows > 0) {
                                                    while ($row = $result->fetch_assoc()) {
                                                        echo '<tr>';
                                                        echo '<td>' . $row['jefe_responsable'] . '</td>';
                                                    ...
                                                    echo '<tr><td colspan="5">Aún no hay solicitudes para mostrar.</td></tr>';
                                                }
                                            } else {
