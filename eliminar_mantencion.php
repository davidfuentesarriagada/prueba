...
$query = "DELETE FROM mantenciones WHERE id = ?";
...
if ($stmt) {
    ...
    if ($stmt->execute()) {
        ...
        if ($stmt->affected_rows > 0) {
            echo "<script>alert('Registro eliminado correctamente.'); window.location.href='http://localhost/prueba/mantenciones.php';</script>";
        } else {
