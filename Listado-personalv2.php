...
<body id="page-top">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"> 
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <img src="img/dada.PNG" class="img-fluid" alt="Imagen Responsiva">
                <p>Para acceder y revisar los datos importantes, debe aceptar los términos y condiciones establecidos. Si no acepta, no podrá ingresar a esta sección.</p>
                </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Agregar un manejador de eventos a los botones Aceptar y Rechazar
            document.querySelectorAll("[data-action]").forEach(function(button) {
                button.addEventListener("click", function() {
                    var action = this.getAttribute("data-action");

                    // Realizar una solicitud AJAX al servidor para enviar la acción
                    var xhr = new XMLHttpRequest();
                    xhr.open("POST", "guardar_respuesta.php", true);
            ...
            // Mostrar el modal cuando el DOM está listo
            myModal.show();
        });
    </script>
