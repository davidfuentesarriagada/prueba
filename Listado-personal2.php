                        ...
                        <div class="col-lg-10 col-sm-12">
                            ...
                            <div class="card shadow mb-5">
                                <div class="container mt-5">
                                    ...
                                    $sql = "SELECT  id_formu, nombre,  Prevision, Enfermedad, Medicamento, Nombre_Emg, Cto_Emg, grupo_sanguineo, a_medicamento, alergia FROM personal LIMIT $offset, $registros_por_pagina";
                                    ...
                                    ?>
                                    <h2>Tabla de Datos Registrados</h2>
                                    <table id="example" class="table-responsive table table-striped table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Enfermedad</th>
                                                <th>Medicamento</th>
                                                <th>Nombre Persona de Emergencia</th>
                                                <th>Contacto Emergencia</th>
                                                <th>Grupo Sanguíneo</th>
                                                <th>¿Alérgico a algún medicamento?</th>
                                                <th>¿Cuál?</th>
                                                <?php
                                                if (isset($_SESSION['rol'])) {
                                                    // Si el usuario ha iniciado sesión, mostrar las opciones según su rol
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>" . $row['Nombre_Emg'] . "</td>";
                                                echo "<td>" . $row['Cto_Emg'] . "</td>";
                                                echo "<td>" . $row['grupo_sanguineo'] . "</td>";
                                                echo "<td>" . $row['a_medicamento'] . "</td>";
