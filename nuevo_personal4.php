                        ...
                        <div class="card-body">
                            <form action="http://localhost/prueba/registro_persona.php" method="POST">
                                <div class="row">
                                    ...
                                    <input type="text" class="form-control" id="rut" name="rut" required placeholder="Ingrese Su Rut...">
                                    </div>
                        
                                    <div class="form-group">
                                        <label for="Hijos">Hijos:</label>
                                        <input type="text" class="form-control" id="Hijos" name="Hijos" placeholder="Ingrese solo Cantidad...">
                                    </div>
                        
                                    <div class="form-group">
                                    <label for="cargo_p">¿ Cargo en comite paritario ?</label>
                                    <input type="text" class="form-control" id="cargo_p" name="cargo_p" placeholder="Ingrese Cargo solo si Pertenece...">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="Prevision" name="Prevision" required >
                                            <option value="">Seleccionar previsión de Salud</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Medicamento" name="Medicamento" placeholder="Ingrese Medicamento Necesario..">
                                    </div><br>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="Movil" name="Movil" required placeholder="Ingrese Fono Particular">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Enfermedad" name="Enfermedad" placeholder="Ingrese Enfermedad Cronica">
                                    </div>

                                    <div class="form-group">
                                        <label for="Nombre_Emg">Nombre contacto de Emeregencia:</label>
                                        <input type="text" class="form-control" id="Nombre_Emg" name="Nombre_Emg" required placeholder="Ingrese el Nombre de un Contacto..">
                                    </div>
                                ...
                                <div class="form-group">
                                    <label for="direccion">Grupo Sanguineo</label>
                                ...
                                <div class="form-group">
                                    <label for="a_medicamento">¿Alérgico a algún medicamento?</label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="a_medicamento" name="a_medicamento" value="si">
                                        <label class="form-check-label" for="a_medicamento">Sí</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group" id="campoa_medicamento" style="display: none;">
                                    <label for="cual_a_medicamento">¿Cuál?</label>
                                    <input type="text" class="form-control" id="cual_a_medicamento" name="cual_a_medicamento" placeholder="Ingrese El medicamento que es alergic@">
                                </div>



                                <script>
                                    document.getElementById('a_medicamento').addEventListener('change', function() {
                                        var campoAlergia = document.getElementById('campoa_medicamento');
                                        campoAlergia.style.display = this.checked ? 'block' : 'none';
                                    });
                                </script><br>

                                <br><input type="submit" value="Guardar" class="btn btn-primary mt-5">
