        ...
        <div id="content-wrapper" class="d-flex flex-column" style="background-image: url(img/Abstract_background_15.jpg);background-size: 100% 100%; background-attachment: fixed; visibility: visible;">
            ...
            <div id="content" >
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Mantenedor de Monitores de Emergencia</h1>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Mantenedor de Monitores de Emergencia</h6>
                                </div>
                                <div class="container mt-5">
                                    <h2>Agregar Extintor</h2><br>
                                    <form action="insert_monitores.php" method="POST" class="row g-3">
                                        <div class="col-md-4">
                                            <label for="monitor" class="form-label">Monitor:</label>
                                            <input type="text" class="form-control" name="monitor" required placeholder="Nombre del Monitor..">
                                        </div>
                                        <div class="col-md-4">
                                            <label for="piso_unidad" class="form-label">Piso/Unidad:</label>
                                            <input type="text" class="form-control" name="piso_unidad" placeholder="Piso o Unidad..">
                                        </div>
                                        <div class="col-md-4">
                                            <label for="cantidad_responsables" class="form-label">Cantidad de Responsables:</label>
                                            <input type="number" class="form-control" name="cantidad_responsables" required placeholder="Ingrese la Cantidad de Responsables..">
                                        </div>
                                        <div class="col-12">
                                            <label for="objetivo" class="form-label">Objetivo:</label>
                                            <textarea class="form-control" name="objetivo" rows="4" placeholder="Descripción del Objetivo.."></textarea>
                                        </div>
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-primary">Agregar Monitor</button>
                                        </div>
                                    </form>
                                    <br>
                                </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p>
                                        ...
                                        ingresando algun nuevo monitor de emergencia.
                                    </p>
