                                            ...
                                            $('#guardarCambiosSocio').click(function() {
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function(response) {
                                                        ...
                                                        // Se recarga la página para reflejar los cambios
                                                        alert('Datos actualizados exitosamente.');
                                                        location.reload(); // Asegura que la página se recargue sólo después de cerrar el modal y recibir la respuesta del servidor
                                                                                                },
