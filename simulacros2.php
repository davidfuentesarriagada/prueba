        ...
        <div id="content-wrapper" class="d-flex flex-column" style="background-image: url(img/Abstract_background_15.jpg);background-size: 100% 100%; background-attachment: fixed; visibility: visible;">
            ...
            <div id="content" >
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Registro de Simulacros</h1>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Registro de Simulacros</h6>
                                </div>
                                <div class="container mt-5">
                                    <h2>Registro de Simulacros</h2>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card">
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        // Consulta SQL para seleccionar los registros de la tabla "Simulacros"
                                            ...
                                            if ($_SESSION['rol'] === 'admin' || $_SESSION['rol'] === 'ejecutivo' || $_SESSION['rol'] === 'general') {
                                                ...
                                                echo '
                                                        <div class="col-md-6 mb-5">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <h5 class="card-title">Planificar un simulacro</h5>
                                                                    <p class="card-text">Esta opción es únicamente para planificar una actividad en relación al simulacro.</p>
                                                                    <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#planificarModal">Planificar</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <div class="modal fade" id="simulacroModal" tabindex="-1" aria-labelledby="simulacroModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="simulacroModalLabel">Listado de Simulacros</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <!-- Agrega aquí tu tabla Bootstrap 5 -->
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <!-- Puedes agregar más botones de acción aquí si es necesario -->
                                </div>
                            </div>
                        </div>
                    </div>
