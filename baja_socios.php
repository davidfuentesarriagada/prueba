    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="background-image: url(img/4.jpg);background-size: 100% 100%; background-attachment: fixed; visibility: visible;">
        ...
        <div id="content-wrapper" class="d-flex flex-column" style="background-image: url(img/Abstract_background_15.jpg);background-size: 100% 100%; background-attachment: fixed; visibility: visible;">
            ...
            <div id="content">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-1 text-gray-800">Listado de bajas de socios</h1>
                <p class="mb-5">Esta herramienta es de uso exclusivo para Administración y Finanzas, en la cual se podrá obstener un listado-historial
                    de las bajas de los socios que ha tenido AIA.
                </p>
                        ...
                        <div class="card shadow mb-5">
                            <div class="container mt-5">
                                <div class="card-header py-3">
                                    <center><h2>Listado-Historial de bajas de socios</h2></center>
                                    <br>
                                    <br>
                                ...
                                $sql = "SELECT id_baja, rut, razon_social, nombre_fantasia , contacto , ano_ingreso, monto_cuota_mensual, tamano_cuotas_sociales, fecha_baja FROM baja_socios LIMIT $offset, $registros_por_pagina";
                                
                                $result = $conn->query($sql);

                                // Contar el total de registros en la tabla de dispositivos para calcular la cantidad de páginas
                                $sql_total_registros = "SELECT COUNT(*) AS total FROM baja_socios";
                                    ...
                                    <table id="example" class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo '<td><button type="button" class="btn btn-danger btn-sm" onclick="eliminarRegistro(' . $row['id_baja'] . ', this)">Eliminar</button></td>';
                                ...
                                <script>
                                    function eliminarRegistro(id_baja, btn) {
                                        if (confirm('¿Estás seguro de que deseas eliminar este registro?')) {
                                            ...
                                            xhr.open('POST', 'eliminar_baja.php', true);
                                            xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
                                            xhr.send('id_baja=' + id_baja);
                                        }
                                    }
