        ...
        <div id="content-wrapper" class="d-flex flex-column" style="background-image: url(img/Abstract_background_15.jpg);background-size: 100% 100%; background-attachment: fixed; visibility: visible;">
            ...
            <div id="content" >
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Mantenedor de Socios</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Mantenedor de Socios</h6>
                                </div>
                                <div class="container mt-5 mb-5">
                                    <h2>Agregar Socios</h2><br>
                                    <form action="insert_socios.php" method="POST" class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="razon_social" placeholder="Nombre de la Empresa" required>
                                        </div>

                                        <div class="col-md-4">
                                            <label for="nombre_fantasia" class="form-label">Nombre de Fantasía:</label>
                                            <input type="text" class="form-control" name="nombre_fantasia" placeholder="Nombre Comercial" required>
                                        </div>

                                        <div class="col-md-4">
                                            <label for="contacto" class="form-label">Contacto:</label>
                                            <input type="email" class="form-control" name="contacto" placeholder="email@ejemplo.com" required>
                                        </div>

                                        <div class="col-md-4">
                                            <label for="anio_ingreso" class="form-label">Año de Ingreso:</label>
                                            <input type="number" class="form-control" name="anio_ingreso" placeholder="2023" min="1900" max="2099" required>
                                        </div>

                                        <div class="col-md-4">
                                            <label for="total_ventas_anuales" class="form-label">Total Ventas Anuales USD$:</label>
                                            <input type="number" class="form-control" id="total_ventas_anuales" name="total_ventas_anuales" placeholder="5000000" min="0" required>
                                        </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p>
                                        Esta herramienta es de uso exclusivo de Area de administracion y finanzas.
                                    </p>
