    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="background-image: url(img/4.jpg);background-size: 100% 100%; background-attachment: fixed; visibility: visible;">
        ...
        <div id="content-wrapper" class="d-flex flex-column" style="background-image: url(img/Abstract_background_15.jpg);background-size: 100% 100%; background-attachment: fixed; visibility: visible;">
            ...
            <div id="content">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-1 text-gray-800">Actas de Sesiones de Directorio</h1>
                        ...
                        <div class="card shadow mb-5">
                            <div class="container mt-5">
                                <div class="card-header py-3">
                                    <center><h2>Actas y/o Sesiones AIA</h2></center>
                                    <br>
                                    <br>
                                ...
                                $sql = "SELECT id, Fecha, Detalles, Asistencia, archivo FROM acta LIMIT $offset, $registros_por_pagina";

                                $result = $conn->query($sql);

                                // Contar el total de registros en la tabla de dispositivos para calcular la cantidad de páginas
                                $sql_total_registros = "SELECT COUNT(*) AS total FROM acta";
                                ...
                                <script>
                                    ...
                                    function eliminarRegistro(id, btn) {
                                        ...
                                        xhr.open('GET', 'eliminar_acta.php?id=' + id, true);
                                        xhr.send();
                                    }
                ...
                <div class="modal fade" id="combinadoModal" tabindex="-1" role="dialog" aria-labelledby="combinadoModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="procesar_combinado.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="detalles">Detalles</label>
                                        <input type="text" class="form-control" id="detalles" name="detalles" required placeholder="Detalles de la sesión">
                                    </div>
                                    <div class="form-group">
                                        <label for="asistencia">Asistencia</label>
                                        <input type="text" class="form-control" id="asistencia" name="asistencia" required placeholder="Asistencia a la sesión">
                                    </div>
