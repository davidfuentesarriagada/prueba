    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="background-image: url(img/4.jpg);background-size: 100% 100%; background-attachment: fixed; visibility: visible;">
        ...
        <div id="content-wrapper" class="d-flex flex-column" style="background-image: url(img/Abstract_background_15.jpg);background-size: 100% 100%; background-attachment: fixed; visibility: visible;">
            ...
            <div id="content">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-1 text-gray-800">Documentos Generales Administración y Finanzas</h1>
                <p class="mb-5">Esta herramienta es de uso exclusivo para Administración y Finanzas, en la cual se podrá registrar alguna sesión de directorio y respaldar su acta digital.</p>
                        ...
                        <div class="card shadow mb-5">
                            <div class="container mt-5">
                                <div class="card-header py-3">
                                    <center><h2>Documentos Generales Administración y Finanzas</h2></center>
                                    <br>
                                    <br>
                                ...
                                $sql = "SELECT id_documento, Fecha, Detalles, Tipo_documento, archivo FROM documentos LIMIT $offset, $registros_por_pagina";

                                $result = $conn->query($sql);

                                // Contar el total de registros en la tabla de dispositivos para calcular la cantidad de páginas
                                $sql_total_registros = "SELECT COUNT(*) AS total FROM documentos";
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                if (!empty($row['archivo'])) {
                                                    ...
                                                    echo "<td><a href='img/documentos/" . $row['archivo'] . "' target='_blank'>" . $row['archivo'] . "</a></td>";
                                                } else {
                                                ...
                                                echo "<td>";
                                                echo '<div><button class="btn btn-primary editar-btn" data-toggle="modal" data-target="#editarModal" data-id_documento="' . $row['id_documento'] . '">Editar</button></div>';
                                                echo '<div><button class="btn btn-danger" onclick="eliminarRegistro(' . $row['id_documento'] . ', this)">Eliminar</button></div>';
                                                echo "</td>"; // Mover esta línea aquí
                                                echo "</tr>";
                                            }
                                            $conn->close();
                                            ?>
                                ...
                                <script>
                                    ...
                                    function eliminarRegistro(id, btn) {
                                        ...
                                        xhr.open('GET', 'eliminar_documento.php?id_documento=' + id, true);
                                        xhr.send();
                                    }
                ...
                <!-- Modal combinado para ingresar nuevos registros y subir documentos -->
                <div class="modal fade" id="combinadoModal" tabindex="-1" role="dialog" aria-labelledby="combinadoModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="combinadoModalLabel">Agregar / Subir Documento</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            ...
                            <div class="modal-body">
                                <form action="procesar_combinado2.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="detalles">Detalles</label>
                                        <input type="text" class="form-control" id="detalles" name="detalles" required placeholder="Detalles del documento">
                                    </div>
                                    <div class="form-group">
                                        <label for="tipo_documento">Tipo de Documento</label>
                                        <input type="text" class="form-control" id="tipo_documento" name="tipo_documento" required placeholder="Tipo de documento">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="nombreArchivo">Nombre del Archivo:<br>Formatos aceptados (.pdf, .doc, .docx, .xls, .xlsx)</label></label>
                                        <input type="text" class="form-control" id="nombreArchivo" name="nombreArchivo" placeholder="Introduce el nombre del archivo">
                                    </div>
                                    <div class="form-group">
