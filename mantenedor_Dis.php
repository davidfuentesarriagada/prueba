                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Mantenedor de Dispositivos</h6>
                                </div>
                                <div class="container mt-5">
                                    <h2>Agregar Dispositivo</h2><br>
                                    <form action="insert_dispositivo.php" method="POST" class="row g-3">
                                        <!-- Campos del formulario (Nombre, Tipo) -->
                                        <div class="col-md-6">
                                            <label for="nombre" class="form-label">Nombre del Dispositivo:</label>
                                            <input type="text" class="form-control" name="nombre" required placeholder="Nombre del dispositivo..">
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" name="tipo" required>
                                                ...
                                                // Consulta SQL para obtener los tipos de dispositivos desde la tabla "dispositivos"
                                                $sql = "SELECT tipo FROM dispositivos";
                                                $result = $conn->query($sql);

                                                // Generar las opciones del campo select con los tipos de dispositivos
                                        ...
                                        <!-- ... Aquí van otros campos del formulario si es necesario ... -->
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-primary">Agregar Dispositivo</button>
                                            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#agregarTipoModal">
                            ...
                            <!-- Modal para agregar nuevo tipo de dispositivo -->
                            <div class="modal fade" id="agregarTipoModal" tabindex="-1" role="dialog" aria-labelledby="agregarTipoModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="agregarTipoModalLabel">Agregar Nuevo Tipo de Dispositivo</h5>
                                            <button type="button" class="close" data-bs-dismiss="modal" aria-label="Cerrar">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <form id="formAgregarTipo" class="form-inline" action="insert_tipo.php" method="POST">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="nuevoTipo" name="tipo" placeholder="Nuevo Tipo" required>
