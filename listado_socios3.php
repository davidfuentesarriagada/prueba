                            ...
                            <div class="card shadow mb-5">
                                <div class="container mt-5">
                                        ...
                                        <table id="example" class="table table-striped" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo '<td><button class="btn btn-primary editar-btn" data-toggle="modal" data-target="#editarModal" data-id="' . $row['id_socio'] . '">Editar</button></td>';
                                                    echo '<td><button type="button" class="btn btn-danger btn-sm" onclick="eliminarSocio(' . $row['id_socio'] . ', this)">Eliminar</button></td>';
                                                    echo '<td><button type="button" class="btn btn-success btn-sm" onclick="darDeBaja(' . $row['id_socio'] . ', this)">Dar Baja</button></td>';
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form id="editarForm" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="nombreFantasia" name="nombre_fantasia">
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="anoIngreso" name="ano_ingreso">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="montoCuotaMensual">Monto Cuota Mensual</label>
                                                            <input type="text" class="form-control" id="montoCuotaMensual" name="monto_cuota_mensual">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="tamanoCuotas">Tamaño según Cuotas Sociales AIA</label>
                                                            <input type="text" class="form-control" id="tamanoCuotas" name="tamano_cuotas">
                                                        </div>
                                                    </form>
                                                </div>
                                    ...
                                    <script>
                                        ...
                                        function eliminarSocio(id_socio, btn) {
                                            ...
                                            $.ajax({
                                                url: 'eliminar_socio.php', // Archivo PHP que procesará la solicitud de eliminación
                                                method: 'GET', // Utilizamos el método GET
                                                data: { id_socio: id_socio }, // Enviamos el ID de la persona a eliminar como datos de la solicitud
                                                success: function(response) {
                                        ...
                                        $('.editar-btn').on('click', function() {
                                            // Obtenemos el ID del socio a editar
                                            var id_socio = $(this).data('id');

                                            // Realizamos la solicitud AJAX para obtener los datos del socio
                                            $.ajax({
                                                url: 'obtener_datos_socio.php', // Archivo PHP que procesará la solicitud de obtención
                                                method: 'GET', // Utilizamos el método GET
                                                data: { id_socio: id_socio }, // Enviamos el ID del socio como datos de la solicitud
                                                success: function(response) {
                                                // Si la solicitud fue exitosa, actualizamos los campos del formulario con los datos del socio
                                                var socio = JSON.parse(response);
                                                $('#socioId').val(socio.id_socio);
                                                $('#rut').val(socio.rut);
                                                $('#razonSocial').val(socio.razon_social);
                                                $('#nombreFantasia').val(socio.nombre_fantasia);
                                                $('#contacto').val(socio.contacto);
                                                $('#anoIngreso').val(socio.ano_ingreso);
                                                $('#montoCuotaMensual').val(socio.monto_cuota_mensual);
                                                $('#tamanoCuotas').val(socio.tamano_cuotas);
                                                },
                                                error: function() {
                                                // Si la solicitud falló, mostramos un mensaje de error
                                                alert('Se produjo un error al obtener los datos del socio.');
                                                }
                                            });
                                        });
                                        ...
                                        $('#guardarCambiosSocio').click(function() {
                                            // Obtiene los valores editados del formulario en el modal
                                            var socioId = $('#socioId').val();
                                            var nombre = $('#nombre').val();
                                            // Obtiene otros valores editados aquí
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(response) {
                                                    ...
                                                    // Recarga la página o actualiza la tabla de socios
                                                    location.reload();
                                                },
