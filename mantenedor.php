                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="container mt-5">
                                    <h2>Agregar Equipo</h2><br>
                                    <form action="insert_equipo.php" method="POST" class="row g-3">
                                        <div class="col-md-4">
                                            <label for="Id_AreaTrabajo" class="form-label">Área de Trabajo:</label>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="tipo_disco" required>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <label for="s_o" class="form-label">Sistema Operativo:</label>
                                            <input type="text" class="form-control" name="s_o" required>
                                        </div>
                                        <div class="col-12">
