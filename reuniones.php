                ...
                <div class="container-fluid" >
                        ...
                        <div class="col-lg-10 col-sm-12">
                            ...
                            <div class="card shadow mb-5">
                                <div class="container mt-5">
                                    ...
                                    $query = "SELECT p.id, p.fecha_reunion, GROUP_CONCAT(c.nombre SEPARATOR ', ') AS asistentes, p.observaciones
                                    ...
                                    $sql_total_registros = "SELECT COUNT(*) AS total FROM planificacion";
                                    ...
                                    <table id="example" class="table-responsive table table-striped table-striped">
                                        ...
                                        <thead>
                                            <tr style="background-color: grey;">
                                                <th style="color: white;">Fecha de Reunión</th>
                                                <th style="color: white;">Asistentes</th>
                        ...
                        <div class="col-lg-2 col-sm-12 mt-3 text-right">
                            <?php
                             if (isset($_SESSION['rol']) && $_SESSION['rol'] === 'admin' || $_SESSION['rol'] === 'ejecutivo' || $_SESSION['rol'] === 'general') {
                                ...
                                echo '<button type="button" class="btn btn-primary btn-block mb-4" data-toggle="modal" data-target="#agregarModal">
                    ...
                    <script>
                        ...
                        function eliminarReunion(id) {
                            ...
                            if (!confirmacion) {
                                return; // Si el usuario cancela, salimos de la función sin eliminar la reunión
                            }

                            var btn = event.target; // El botón que ha sido clicado
                            var row = btn.closest("tr"); // Obtenemos la fila que contiene el botón que ha sido clicado
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="POST" action="guardar_reunion.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="asistentes" name="asistentes[]" multiple required>
                                                ...
                                                $query = "SELECT id, nombre FROM cparitario"; // Modifica esta consulta según el nombre de la tabla donde tienes las personas registradas
                                                $result = $conn->query($query);

                                                // Obtén los IDs de los asistentes que deben estar preseleccionados (por ejemplo, desde una base de datos o cualquier otra fuente)
                                                $idsPreseleccionados = array(1, 3); // Coloca aquí los IDs que deben estar seleccionados por defecto

                                                // Genera las opciones del campo de selección
                                                while ($row = $result->fetch_assoc()) {
                                                    $selected = in_array($row['id'], $idsPreseleccionados) ? 'selected="selected"' : '';
                                    ...
                                    <script>
                                        // Habilitar la selección múltiple para el campo de selección de asistentes
                                        document.getElementById("asistentes").setAttribute("size", "5");
                                    </script>
                                </div>
                            </div>
                        </div>
