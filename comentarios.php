        ...
        // Verificar el rol del usuario
            ...
            if (isset($_SESSION['rol'])) {
                ...
                if ($_SESSION['rol'] === 'admin' || $_SESSION['rol'] === 'ejecutivo' || $_SESSION['rol'] === 'general') {
                    ...
                    // Puedes omitir estas secciones para que no se muestren en el Sidebar del visualizador
                }
                // Otras condiciones para diferentes roles, si es necesario
            }
            ?>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Listado de Comentarios</h6>
                                </div>
                                <?php
                                ...
                                $sql = "SELECT id, nombre_usuario, comentario, fecha_creacion FROM comentarios";
                                $result = $conn->query($sql);

                                $sql_total_registros = "SELECT COUNT(*) AS total FROM comentarios";
