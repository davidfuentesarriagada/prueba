        ...
        <div id="content-wrapper" class="d-flex flex-column" style="background-image: url(img/Abstract_background_15.jpg);background-size: 100% 100%; background-attachment: fixed; visibility: visible;">
            ...
            <div id="content" >
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Registro de Actividad en RecSys</h1>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">logs Activity</h6>
                                </div>
                                <div class="container mt-5">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            // Conecta a la base de datos y realiza la consulta para obtener los registros de actividad
                                            ...
                                            $query = "SELECT * FROM registros_actividad";
                                            $result = $conn->query($query);

                                            // Itera a través de los registros y muestra cada uno
