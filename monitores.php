        ...
        <div id="content-wrapper" class="d-flex flex-column" style="background-image: url(img/Abstract_background_15.jpg);background-size: 100% 100%; background-attachment: fixed; visibility: visible;">
            ...
            <div id="content" >
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Monitores Guías ante una Emergencia</h1>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Monitores Emergencia </h6>
                                </div>
                                <?php
                                ...
                                $sql = "SELECT MonitorID, Monitor, Piso_Unidad, Cantidad_Responsables, Objetivo FROM monitores";
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                if (isset($_SESSION['rol'])) {
                                                    ...
                                                    if ($_SESSION['rol'] === 'admin' || $_SESSION['rol'] === 'ejecutivo' || $_SESSION['rol'] === 'general') {
                                                        // Mostrar opciones para administrador
                                                        echo '<td>';
                                                        echo '<button class="btn btn-danger" onclick="eliminarRegistro(\'' . $row['MonitorID'] . '\')">Eliminar</button>';
                                                        echo '</td>';
                                                    }
                                                }
                            ...
                            <script>
                                function eliminarRegistro(id) {
                                    ...
                                    if (respuesta) {
                                        fetch('eliminar_monitor.php?id=' + id, {
