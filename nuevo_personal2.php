            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="http://localhost/prueba/registro_persona2.php" method="POST">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="Nombre_Emg">Nombre contacto de Emergencia:</label>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" id="a_medicamento" name="a_medicamento" value="si">
                                        ...
                                        <div class="form-group" id="campoa_medicamento" style="display: none;">
                                            ...
                                            <input type="text" class="form-control" id="cual_a_medicamento" name="cual_a_medicamento" placeholder="Ingrese El medicamento que es alérgico">
                                        </div>
